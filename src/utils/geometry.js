...
export const star = (x, y, scale, rotation) => {
  ...
  v.push(
    rotatePoint(
      x + Math.cos((TAU * 5) / 5) * scale,
      y + Math.sin((TAU * 5) / 5) * scale,
      x,
      y,
      rotation
    )
  ...
  v.push(
    rotatePoint(
      x + Math.cos((TAU * 3) / 5) * scale,
      y + Math.sin((TAU * 3) / 5) * scale,
      x,
      y,
      rotation
    )
  ...
  v.push(
    rotatePoint(
      x + Math.cos((TAU * 1) / 5) * scale,
      y + Math.sin((TAU * 1) / 5) * scale,
      x,
      y,
      rotation
    )
  ...
  v.push(
    rotatePoint(
      x + Math.cos((TAU * 4) / 5) * scale,
      y + Math.sin((TAU * 4) / 5) * scale,
      x,
      y,
      rotation
    )
  ...
  v.push(
    rotatePoint(
      x + Math.cos((TAU * 2) / 5) * scale,
      y + Math.sin((TAU * 2) / 5) * scale,
      x,
      y,
      rotation
    )
  ...
  v.push(
    rotatePoint(
      x + Math.cos((TAU * 0) / 5) * scale,
      y + Math.sin((TAU * 0) / 5) * scale,
      x,
      y,
      rotation
    )
