...
const updateGUI = () => {
  ...
  switch (display.current) {
    case "boundedSin": {
      ...
      controllers.push(ff.add(displayParams, "period", 0.1, 10, 0.1));
      controllers.push(ff.add(displayParams, "yMin", -1, 0, 0.1));
      controllers.push(ff.add(displayParams, "yMax", 0, 1, 0.1));
