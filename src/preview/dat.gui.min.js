...
!(function (e, t) {
  ...
  function l(e, t, n, o) {
    (e.style.background = ""),
      S.each(ee, function (i) {
        e.style.cssText +=
          "background: " + i + "linear-gradient(" + t + ", " + n + " 0%, " + o + " 100%); ";
      });
  }
  function d(e) {
    (e.style.background = ""),
  ...
  function c(e, t, n) {
    ...
    return (
      t && o.appendChild(t), n ? e.__ul.insertBefore(o, n) : e.__ul.appendChild(o), e.onResize(), o
    );
  }
  function u(e) {
  ...
  var U = /(\d+(\.\d+)?)px/,
    ...
    re = (function (e) {
      if (e && "undefined" != typeof window) {
        ...
        return (
          t.setAttribute("type", "text/css"), (t.innerHTML = e), document.head.appendChild(t), e
        );
      }
    })(
